<template>
  <div class="container">
    <form @submit.prevent="submitForm" class="article-form">
      <h2 class="form-title">Ajouter une news</h2>

      <div class="form-columns">
        <!-- Left column -->
        <div class="form-column">
          <div class="form-group">
            <label for="titreFront">Titre de la news :</label>
            <input type="text" id="titreFront" v-model="news.titre" required>
          </div>
          <div class="form-group">
            <label for="description">Description :</label>
            <textarea id="description" v-model="news.description" required></textarea>
          </div>
          <div class="form-group">
